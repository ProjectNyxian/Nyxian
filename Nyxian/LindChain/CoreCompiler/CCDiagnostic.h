...
CC_EXPORT CCDiagnosticRef CF_RETURNS_RETAINED CCDiagnosticCreate(CFAllocatorRef allocator, CCDiagnosticType type, CCDiagnosticLevel level, CFURLRef fileURL, CCSourceLocation location, CFStringRef message);
